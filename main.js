...
function load(){
    ...
    mainChar.y = window.innerHeight - 69;
...
function draw(){
    ...
    //Background layer 1
    context.save();
    context.translate(cameraX * 0.1, cameraY * 0.1);
    ...
    //Background layer 2
    context.save();
    context.translate(cameraX * 0.7, cameraY * 0.7);
    ...
    //Background layer 3
    context.save();
    context.translate(cameraX * 0.9, cameraY * 0.9);
